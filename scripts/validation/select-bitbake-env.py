...
EXACT = {
    ...
    "INITRAMFS_MAXSIZE", "LOCAL_DEVELOPMENT_BUILD", "MACHINE", "MACHINE_FEATURES",
    "MODSIGN", "SIGN_ENABLE", "TF_A_SIGN_ENABLE", "UEFI_SIGN_ENABLE",
    "PACKAGE_INSTALL", "SDKIMAGE_FEATURES", "TOOLCHAIN_TARGET_TASK",
    "WKS_FILE",
}
PREFIXES = (
    "FIT_", "KERNEL_", "MODSIGN_", "OPTEE_", "OSTREE_", "PREFERRED_PROVIDER_",
    "PREFERRED_VERSION_", "SIGNING_", "SOTA_", "TF_A_", "UBOOT_", "UEFI_",
)
