...
CORE_IMAGE_BASE_INSTALL:append:imx8mm-jaguar-sentai = " \
    ...
    gstreamer1.0-meta-base gstreamer1.0-rtsp-server gstreamer1.0 gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad gstreamer1.0-plugins-ugly gstreamer1.0-libav \
"
